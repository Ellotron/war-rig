standardEquipTokens1 = {
  --
  {
    ...
    rotation = { x = 17.6202983856201, y = 0.0267729070037603, z = 0.006896972656 }
  },
  --
  {
    guid = 'e7362e',
    position = { x = 3.54453563690186, y = 1.6035567522049, z = 12.7015419006348 },
    rotation = { x = 17.1596298217773, y = 0.0402608886361122, z = 0.007202148438 }
  },
  --
  {
    guid = '685894',
    position = { x = 1.15451717376709, y = 1.59446084499359, z = 12.7601804733276 },
    rotation = { x = 16.547779083252, y = 0.0479310601949692, z = 0.040573120117 }
  },
}
standardEquipment1 = {
  -- P-rifles
...
lesserFactions1 = {
  {
    ...
    positions = {
      [4] = {
          ...
          rotation = { x = 1.76389221451245E-05, y = 0.0371186621487141, z = 0 }
        },
      [6] = {
          position = { x = 17.5578708648682, y = 1.80116498470306, z = 1.4036511182785 },
          rotation = { x = 7.75255648477469E-06, y = 0.0334337763488293, z = 0 }
        }
    }
  },
  {
    ...
    positions = {
      [4] = {
          ...
          rotation = { x = -1.08036124402133E-06, y = 359.993438720703, z = 0 }
        },
      [6] = {
          position = { x = 18.6400489807129, y = 1.80116486549377, z = -0.270787417888641 },
          rotation = { x = -2.34928074860363E-06, y = 359.989135742188, z = 0 }
        }
    }
  },
  {
    ...
    positions = {
      [4] = {
          ...
          rotation = { x = -2.02003448066534E-05, y = 0.00264669861644506, z = 0 }
        },
      [6] = {
          position = { x = 19.6346912384033, y = 1.80116510391235, z = 1.52125334739685 },
          rotation = { x = -7.48338425182737E-06, y = 0.00262279249727726, z = 0.000015258789 }
        }
    }
  }
}
...
baseTokens1 = {
  {
    ...
    rotation = { x = 0.000457693182397634, y = 359.663299560547, z = 0.000961303711 }
  },
  {
    guid = '2348af',
    position = { x = 7.77677345275879, y = 1.94099497795105, z = 5.18696212768555 },
    rotation = { x = -0.000312448682961985, y = 358.586456298828, z = 0.004150390625 }
  },
  {
    guid = 'bfe2e4',
    position = { x = 7.6932430267334, y = 1.94107663631439, z = 9.20827198028564 },
    rotation = { x = -0.00196630787104368, y = 1.21083056926727, z = 0.001312255859 }
  },
}
